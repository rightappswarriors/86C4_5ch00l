...
<div class="card">
  <div class="card-body">
	...
	<div class="d-flex justify-content-between">
		...
		<div class="dropdown">
		<button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Select List By Grade Level </button>
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
			<code>
			<a class="dropdown-item" href="#<?=site_url("students/gradelevel/RR/")?>">RR-K1</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/ABCs/")?>">ABCs-K2</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-1/")?>">Level-1</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-2/")?>">Level-2</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-3/")?>">Level-3</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-4/")?>">Level-4</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-5/")?>">Level-5</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-6/")?>">Level-6</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-7/")?>">Level-7</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-8/")?>">Level-8</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-9/")?>">Level-9</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Level-10/")?>">Level-10</a>
			<div class="dropdown-divider"></div>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Grade-11/")?>">Grade-11</a>
			<a class="dropdown-item" href="<?=site_url("students/gradelevel/Grade-12/")?>">Grade-12</a>
			</code>
		</div>
		</div>
		<?php endif; ?>
