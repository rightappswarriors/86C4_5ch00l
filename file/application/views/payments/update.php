		...
		<div class="row">
			...
			<div class="col-md-4" style="text-align:left;">
				<div class="form-group row">
					...
					<div class="col-sm-9"><input type="text" class="form-control" name="invoice_number" value="<?=$row_master->invoice_number?>" placeholder="Invoice Number"></div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<?php
						...
						$batch = set_value('enrollpay',$row_master->enrollpay);
