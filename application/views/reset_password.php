...
<html lang="en">
  <head>
    ...
    <style>
        ...
        .password-requirements { background-color: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px; }
        .password-requirements h6 { color: #333; margin-bottom: 10px; font-weight: 600; }
        .password-requirements ul { margin: 0; padding-left: 20px; color: #666; }
    </style>
  </head>
  <body>
                  ...
                  <form action="<?=site_url('login/update_password')?>" method="post">
                      <div class="form-group">
                          ...
                          <div class="input-icon">
                              ...
                              <span class="password-toggle" onclick="togglePassword('new_password')"><i class="mdi mdi-eye-off"></i></span>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="input-icon">
                              ...
                              <span class="password-toggle" onclick="togglePassword('confirm_password')"><i class="mdi mdi-eye-off"></i></span>
                          </div>
                          <div id="password-match" class="text-danger" style="display: none; margin-top: 5px;"><small><i class="mdi mdi-alert-circle"></i> Passwords do not match</small></div>
                      </div>
