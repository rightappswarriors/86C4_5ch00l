        ...
        <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <h2 class="text-center mb-4">Successfully Registered!</h2>
              <div class="auto-form-wrapper">
			  
                
                  <p>You can now proceed for Login to our Portal!</p>                  
                  <div class="form-group">
                    <a href="<?=site_url("login")?>" class="btn btn-primary submit-btn btn-block">Login</a>
                  </div>
