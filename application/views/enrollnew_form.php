	...
	<div class="card">
	  <div class="card-body">
		...
		<form class="formenroll" id="frmenroll" action="<?=site_url("students/enrollnew_submit")?>" method="POST">
		  <p class="card-description text-info"> Please fill-out all the fields. Not applicable just put N/A. </p>
		  ...
		  <p class="card-description text-info"> Complete Home Address </p>
		  <div class="row">
			<div class="col-md-6">
			  <div class="form-group row">
		  ...
		  <div class="row">
			...
			<div class="col-md-6">
			  <div class="form-group row">
				...
				<div class="col-sm-9">
				  <input type="text" name="father_email" value="<?=set_value('father_email')?>" class="form-control" />
				</div>
			  </div>
			</div>
		  </div>
		  ...
		  <div class="row">
			...
			<div class="col-md-6">
			  <div class="form-group row">
				...
				<div class="col-sm-9">
				  <input type="text" name="father_fbmessenger" value="<?=set_value('father_fbmessenger')?>" class="form-control" />
				</div>
			  </div>
			</div>
		  </div>
		  ...
		  <h4><code>NOTE: PLEASE make sure all the information you entered above is true and correct.</code></h4>
			...
			<h4 style="color:red"><span class="blink">PLEASE Check your student assesment section page after 24 hours.</span> You cannot finalize this enrollment process unless you agree with the assesment.</h4>	
		  </div>
		  </div>
		  </div>
