<div class="col-lg-12 grid-margin stretch-card">
	...
	<div class="card">
	  <div class="card-body">
		...
		<h3 class="heading" style="text-align:center;">Create New User</h3>
		<hr>
		
		<?=validation_errors()?>
		
		<form class="form-sample" action="<?=site_url("users/create_submit/")?>" method="POST">
		  ...
		  <div class="row">
			<div class="col-md-6">
			  <div class="form-group row">
				...
				<div class="col-sm-9">
				  <input type="text" name="usertype" value="<?= set_value("usertype","Teacher") ?>" class="form-control" />
				</div>
			  </div>
			</div>
			<div class="col-md-6">
		  ...
		  <input type="submit" class="btn btn-lg btn-success" name="submit" value="SAVE">
		  </div>
