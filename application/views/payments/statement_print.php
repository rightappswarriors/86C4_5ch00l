...
?>
		...
		<center><img src="<?=dirname(base_url())?>/assets/images/logo_portal.png" width="100"><br>
		<span style='color:#999;'>Cebu Bob Hughes Christian Academy<br>
		55 Katipunan St., Calamba, Cebu City<br>
		Telephone: (032) 261-1900 Fax: (032) 505-6960</span></center>
		<br>
		<h3 class="heading" style="text-align:center;"><u>Statement of Account</u></h3>
		
		
		
		<div class="col-md-12" style="text-align:left;margin-bottom:20px;">
		<h4>Student: <?= $row->lastname . ", " . $row->firstname ?><br>Grade-level: <?=$row->gradelevel?></h4>
		</div>
