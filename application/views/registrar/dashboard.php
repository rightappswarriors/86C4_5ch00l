		...
		<div class="card">
		  <div class="card-body">
			<div class="d-flex justify-content-between">
			  <h4 class="card-title mb-0">5 Most Recent Enrollment Activity </h4>
			...
			<div class="row">
				...
				if($count_newold_students->num_rows() > 0)
				{
					foreach ($count_newold_students->result() as $row2):
						...
						<p class="mb-0"><?=strtoupper($row2->newold)?></p>
						</div>
				...
				if($count_gradelevel_students->num_rows() > 0)
				{
					foreach ($count_gradelevel_students->result() as $row1):
						...
						<div class="d-flex w-100 pt-2">
							<p class="mb-0 font-weight-semibold"><code><?=$row1->gradelevel?></code></p>
