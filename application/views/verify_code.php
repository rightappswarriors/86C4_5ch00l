			...
			<div class="col-lg-4 mx-auto">
			  ...
			  <div class="auth-form">
				  ...
				  <div class="delivery-info">
					<p><i class="mdi mdi-email-outline"></i> Code sent to: <strong><?=$masked_email?></strong></p>
					<p><i class="mdi mdi-cellphone"></i> Code sent to: <strong><?=$masked_mobile?></strong></p>
				  </div>
				  
				  <form id="verify-form" action="<?=site_url('login/verify_code_submit')?>" method="post">
					  <div class="form-group">
						  <label for="code">Verification Code</label>
						  <input type="text" class="form-control" id="code" name="code" 
							 placeholder="Enter 6-digit code" maxlength="6" required autocomplete="off">
						  <small class="form-text text-muted">Enter the 6-digit code sent to your email and phone</small>
					  </div>
					  ...
					  <div class="text-center mt-3">
						  ...
						  <p>
							  <a href="javascript:void(0)" class="resend-link disabled" id="resend-link">
								  <i class="mdi mdi-refresh"></i> Resend Verification Code
							  </a>
						  </p>
					  </div>
