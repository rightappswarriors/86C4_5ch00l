    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <span class="ml-3 text-white text-sm mt-20" style=" font-size:12px;">Version: <span class="font-semibold">0.0.0.19</span></span>
        </nav>
        <!-- partial -->
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright &copy; <?php echo date("Y"); ?> <a href="http://www.bobhughes.edu.ph/" target="_blank">Bob Hughes Christian Academy</a>. All rights reserved.</span>
