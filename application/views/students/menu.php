...
<div class="col-sm-10">
    <div class="student-info-card">
        <div class="student-info-main">
            ...
            <div class="parent-info-summary">
                <div class="parent-info-item">
                    <span class="parent-label">Father</span>
                    <span class="parent-name">Name: <?= $row->father_firstname . " " . $row->father_lastname ?></span>
                </div>
                <div class="parent-info-item">
                    <span class="parent-label">Mother</span>
                    <span class="parent-name">Name: <?= $row->mother_firstname . " " . $row->mother_lastname ?></span>
                </div>
            </div>
        </div>
    </div>
