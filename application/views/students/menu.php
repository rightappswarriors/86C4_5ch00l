...
<div class="col-sm-10">
<h3> <?= $row->firstname . " " . $row->lastname ?> <code style="font-size:14px;"><?=$row->newold?> student</code> <code class="text-info">(<?=$row->enrollstatus?>)</code> <!--<a href="<?=site_url("students/preenroll_form/".$row->id)?>" class="btn btn-md btn-primary">Application for Pre-enrollment</a>--> <code style="font-size:16px;" class="text-danger"><br><b>Issue PACE? <?=$row->ableforpt?></b></code></h3>
</div>
<div class="col-sm-2">
