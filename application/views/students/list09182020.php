  ...
  <div class="card-body">
	...
	<div class="d-flex justify-content-between">
		...
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
			<code>
			<a class="dropdown-item" href="<?=site_url("students/index/All")?>">All Students</a>
			<a class="dropdown-item" href="<?=site_url("students/index/Active")?>">Active</a>
			<a class="dropdown-item" href="<?=site_url("students/index/Pending")?>">Pending</a>
			<a class="dropdown-item" href="<?=site_url("students/index/Assessed")?>">Assessed</a>
...
<div class="card">
  <div class="card-body">
	...
	<p><mark><code>Assessed</code></mark>  Once your status already "Assessed", go to (Student Details -> Registrar Assessment) page and click the agree button below to proceed. </p>
