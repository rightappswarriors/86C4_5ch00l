				...
				<li><b>School Support</b>
					<ol style="list-style-type:upper-alpha">
						<li>Educational Support
							...
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="11" <?=set_checkbox('interview[]', $interviews[11], $interviews[11]==1?TRUE:FALSE)?> class="form-check-input">Willing to coach and parent our children through the educational process</label>
							</div></li>
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="12" <?=set_checkbox('interview[]', $interviews[12], $interviews[12]==1?TRUE:FALSE)?> class="form-check-input">Attend parent programs (PT conferences, PTFs, Special Events) whether F2F or virtual</label>
							</div></li>
							</ol>
						</li>
						<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="13" <?=set_checkbox('interview[]', $interviews[13], $interviews[13]==1?TRUE:FALSE)?> class="form-check-input">Spiritual (prayer and encouragement)</label>
							</div></li>
					</ol>
				</li>
				<li><b>Furniture and Technical Support</b>
					<ol style="list-style-type:upper-alpha">
						<li>Availability of Technical Equipment
							...
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="14" <?=set_checkbox('interview[]', $interviews[14], $interviews[14]==1?TRUE:FALSE)?> class="form-check-input">Smart Phone</label>
							</div></li>
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="15" <?=set_checkbox('interview[]', $interviews[15], $interviews[15]==1?TRUE:FALSE)?> class="form-check-input">Tablet</label>
							</div></li>
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="16" <?=set_checkbox('interview[]', $interviews[16], $interviews[16]==1?TRUE:FALSE)?> class="form-check-input">Computer (with Camera and Mic)</label>
							</div></li>
							</ol>
						</li>
						<li>Connectivity
							...
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="17" <?=set_checkbox('interview[]', $interviews[17], $interviews[17]==1?TRUE:FALSE)?> class="form-check-input">Responsible for load and access during school hours</label>
							</div></li>
							<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="18" <?=set_checkbox('interview[]', $interviews[18], $interviews[18]==1?TRUE:FALSE)?> class="form-check-input">Internet access</label>
							</div></li>
							</ol>
						</li>
						<li><div class="form-check form-check-flat">
								<label class="form-check-label">			  
								<input type="checkbox" name="interview[]" value="19" <?=set_checkbox('interview[]', $interviews[19], $interviews[19]==1?TRUE:FALSE)?> class="form-check-input">Study Space (a place to read write with limited interruptions)</label>
							</div></li>
					</ol>
				</li>
			</ol>
