	...
	<div class="card enroll-card">
	  <div class="card-body p-0">
		...
		<form class="enroll-form" id="frmfetcher" action="<?=site_url("students/fetcher_id_submit")?>" method="POST">
		  ...
		  <div class="fetcher-section" data-index="0">
		  <div class="row">
			<div class="col-md-4">
		  ...
		  <div class="enroll-add-btn">
			<button type="button" class="btn btn-enroll btn-add" id="add-fetcher-btn">
				<i class="mdi mdi-plus"></i> Add another fetcher
			</button>
		  </div>
...
<button type="button" class="btn btn-remove-student" onclick="removeStudent(this)">Remove</button>
</div>
</div>

<!-- Hidden template for cloning fetcher section -->
<div id="fetcher-template" style="display:none;">
<div class="fetcher-section" data-index="__INDEX__">
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			<label class="form-label">First Name <span style="color:red;">*</span></label>
			<input type="text" name="fetcher[__INDEX__][firstname]" class="form-control" placeholder="Enter First Name" required>
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
			<label class="form-label">Middle Name</label>
			<input type="text" name="fetcher[__INDEX__][middlename]" class="form-control" placeholder="Enter Middle Name">
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
			<label class="form-label">Last Name <span style="color:red;">*</span></label>
			<input type="text" name="fetcher[__INDEX__][lastname]" class="form-control" placeholder="Enter Last Name" required>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			<label class="form-label">Relationship to Student <span style="color:red;">*</span></label>
			<select name="fetcher[__INDEX__][relationship]" class="form-control" required>
				<option value="">-- Select Relationship --</option>
				<option value="Father">Father</option>
				<option value="Mother">Mother</option>
				<option value="Guardian">Guardian</option>
	...
	<div class="col-md-4">
		<div class="form-group">
			<label class="form-label">Contact Number <span style="color:red;">*</span></label>
			<input type="text" name="fetcher[__INDEX__][contact_number]" class="form-control" placeholder="09xxxxxxxxx" required>
		</div>
	</div>
</div>
<button type="button" class="btn btn-remove-fetcher" onclick="removeFetcher(this)">Remove</button>
</div>
</div>
...
$(function(){
	...
	$("#add-fetcher-btn").click(function() {
		var index = $(".fetcher-section").length;
		var template = $("#fetcher-template").html().replace(/__INDEX__/g, index);
		$("#fetcher-sections").append(template);
	});
...
function removeFetcher(btn) {
	$(btn).closest(".fetcher-section").remove();
}
</script>