...
<h3> <?= $row->firstname . " " . $row->lastname ?> <code style="font-size:14px;"><?=$row->newold?> student</code> <code class="text-info">(<?=$row->enrollstatus?>)</code> <a href="#" class="btn btn-md btn-primary">Application for Pre-enrollment</a> <code style="font-size:16px;" class="text-danger"><br>Able to take PACE Test: <?=$row->ableforpt?></code></h3>
